        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="card border-dark shadow-sm" style="border-radius: 15px;">
                    <div class="card-body p-4 text-center" style="height: 150px; background-color: #ffffff; border-top-left-radius: 15px; border-top-right-radius: 15px;">
                    ...
                    <div class="card-footer text-center p-3" style="background-color: #dbe7fd; border-bottom-left-radius: 15px; border-bottom-right-radius: 15px; border-top: 1px solid #000;">
                        <h5 class="fw-bold text-dark">Lorem Ipsum</h5>
                        <p class="mb-1 text-dark">Lorem ipsum dolor sit amet consectetur.</p>
